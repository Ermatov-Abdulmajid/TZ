...
(function (HTMLService) {
    ...
    function findDefinitionsInInnerStyle(document, selector) {
        ...
        for (let { document: cssDocument, service: cssService, index: styleIndex } of services) {
            ...
            for (let location of cssLocations) {
                ...
                let targetRange = vscode_languageserver_1.Range.create(document.positionAt(startIndexInHTML), document.positionAt(endIndexInHTML));
                let selectionRange = vscode_languageserver_1.Range.create(targetRange.start, targetRange.start);
                let htmlLocation = vscode_languageserver_1.LocationLink.create(document.uri, targetRange, selectionRange, selector.toRange());
...
})(HTMLService || (exports.HTMLService = HTMLService = {}));
